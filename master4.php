...
if($isLogged=true)
{
	echo '<li><a href="managestudent.php"><span class="glyphicon glyphicon-wrench"></span> Manage Students</a></li>';
	echo '<li><a href="managestudent.php"><span class="glyphicon glyphicon-briefcase"></span> Profile</a></li>';
	echo '<li><a href="managestudent.php"><span class="glyphicon glyphicon-off"></span> Logout</a></li>';
